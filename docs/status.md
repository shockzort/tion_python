...
- Фаза 4 = **гейт MVP**: VPS (frps+nginx+TLS через DuckDNS — ADR-0006),
  frpc на хосте, регистрация приватного навыка, линковка, голосовой
  чек-лист — пошагово в `docs/yandex-setup.md`. Код и contract-тесты готовы.
